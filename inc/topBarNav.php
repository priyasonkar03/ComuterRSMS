...
<!-- Navbar -->
      ...
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-dark" id='top-Nav'>
        ...
        <div class="container">
        <!-- this is Dynamic logo code  -->  
        <a href="./" class="navbar-brand">
            <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Site Logo" class="brand-image img-circle mb-2 elevation-3" style="width: 80px; height: 80px; margin:0%;">
            <span style="font-size: 50px; "><?= $_settings->info('short_name') ?></span>
        </a>
          <!-- this is static logo code  -->
          <!-- <a href="./" class="navbar-brand">
          <img src="../uploads/client-4.png" alt="Site Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
